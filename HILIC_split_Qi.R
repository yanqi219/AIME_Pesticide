...
split.pest <- function(pest){
  ...
  file.dir = paste("C:/Users/Qi/Dropbox/AIME/Pesticide/HILICpos/HILIC_",pest,"/PANDA_input", sep = "")
  setwd(file.dir)
...
setwd("C:/Users/Qi/Dropbox/AIME/Panda_HILICpos")
...
class <- "C:/Users/Qi/Dropbox/AIME/Panda_HILICpos/HILIC_classlabels_for_panda_all.txt"
feature <- "C:/Users/Qi/Dropbox/AIME/Panda_HILICpos/HILIC_ftrsmzcalib_combat_ordered_all.txt"
outloc <- "C:/Users/Qi/Dropbox/AIME/Panda_HILICpos"
...
# get the class table
class<-read.table("C:/Users/Qi/Dropbox/AIME/Panda_HILICpos/HILIC_classlabels_all.txt",header = T)
...
save(class, wide_save_residual, file = "C:/Users/Qi/Dropbox/AIME/Panda_HILICpos/HILIC_all_residual.RData") ## for WGCNA
