...
HILIC_common_autism <- HILIC_autism[which(HILIC_autism$mz %in% HILIC_ap$mz),]

C18_common_ap <- C18_ap[which(C18_ap$mz %in% C18_autism$mz),]
C18_common_autism <- C18_autism[which(C18_autism$mz %in% C18_ap$mz),]
